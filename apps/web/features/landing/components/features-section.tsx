    ...
    <div className="relative aspect-video overflow-hidden rounded-lg border bg-background text-foreground shadow-2xl">
      ...
      <div className="flex h-10 shrink-0 items-center border-b bg-background px-4 text-sm">
        <div className="flex items-center gap-1.5 min-w-0 text-xs">
          <span className="text-muted-foreground">XCT Demo</span>
          <ChevronRight className="h-3 w-3 text-muted-foreground/50 shrink-0" />
          <span className="text-muted-foreground">XCT-18</span>
          <ChevronRight className="h-3 w-3 text-muted-foreground/50 shrink-0" />
...
const mockToolCalls = [
  ...
  { type: "tool_result" as const, preview: "ok  \tgithub.com/xct/server/internal/handler\t0.847s" },
];
