...
export const PROJECT = {
  ...
  description:
    "A few things to try in XCT. Work through them at your own pace.",
};
...
export function buildWelcomeIssueText(
  ...
  const header = [
    ...
    ``,
    `[Learn how XCT works →](https://multica.ai/docs/how-multica-works)`,
    ``,
    `---`,
    ``,
  ].join("\n");
  ...
  const sharedInstructions = [
    ...
    `2. **Explain how we work together in XCT**:`,
  ...
  switch (q.use_case) {
    case "coding":
      return {
        title: "👋 Welcome to XCT — let's work together",
        description: `${header}Hi agent, this is ${name}'s first time using XCT. They plan to use you mostly for **coding work**.\n\n${sharedInstructions}`,
      };
    case "planning":
      return {
        title: "👋 Welcome to XCT — let's work together",
        description: `${header}Hi agent, this is ${name}'s first time using XCT. They want your help with **planning and breaking down work**.\n\n${sharedInstructions}`,
      };
    case "writing_research":
      return {
        title: "👋 Welcome to XCT — let's work together",
        description: `${header}Hi agent, this is ${name}'s first time using XCT. They'll use you for **research and writing** — drafting, summarizing, analysis.\n\n${sharedInstructions}`,
      };
    case "explore":
      return {
        title: "👋 Welcome to XCT — let's work together",
        description: `${header}Hi agent, this is ${name}'s first time using XCT. They're **exploring** what XCT can do — no specific goal yet.\n\n${exploreInstructions}`,
      };
    case "other": {
      ...
      return {
        title: "👋 Welcome to XCT — let's work together",
        description: `${header}Hi agent, this is ${name}'s first time using XCT. ${contextLine}\n\n${sharedInstructions}`,
      };
    }
    default:
      return {
        title: "👋 Welcome to XCT — let's work together",
        description: `${header}Hi agent, this is ${name}'s first time using XCT.\n\n${sharedInstructions}`,
      };
  }
}
...
export function buildAgentGuidedSubIssues(
  ...
  const tier1: ImportStarterIssuePayload[] = [
    {
      ...
      description: [
        `**Every issue has a right-side panel** called **Properties**. From there you control who works on what. Agents in XCT are triggered when an issue has:`,
        ``,
  ...
  if (q.team_size === "team") {
    tier2.push({
      ...
      description: [
        `XCT works best when a small team shares agents.`,
        ``,
        `**Where to find it**:`,
